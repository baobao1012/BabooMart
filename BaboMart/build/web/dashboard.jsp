                    ...
                    <tbody>
                        <c:forEach items="${listSanPham}" var="p">
                            <tr>
                                ...
                                <td>${p.getGiagoc()} $</td>
                                <td>
                                    <a href="load?Masanpham=${p.getMasanpham()}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="delete?Masanpham=${p.getMasanpham()}" class="delete" data-toggle="modal" onclick="doDelete(${p.getMasanpham()})"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
